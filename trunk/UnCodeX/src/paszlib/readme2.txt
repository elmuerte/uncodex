Change Log
==========
May 24th 2002 - Changed by Finn Tolderlund, Denmark.
Changed several units to be compatible with Delphi6. 
Original paszlib downloadet from: http://www.nomssi.de/paszlib/paszlib.html
The changed units are: 
Adler.pas - changed NMAX from 3854 to 5552
infblock.pas - changed strutils to zstrutils
infcodes.pas - changed strutils to zstrutils
inffast.pas - changed strutils to zstrutils
inftrees.pas - added compiler directive {$J+}
Trees.pas - added compiler directive {$J+}
Zconf.inc - enabled compiler directive {$DEFINE Delphi5}
zstrutils.pas - renamed from strutils to zstrutils to avoid conflict with new Delphi6 unit with same name
Zutil.pas - moved 'end.' line to actual end of unit to avoid compiler warning
I have only tested it slightly. It seems to work, but I do not guarantee anything.
Use of this source code is entirely on your own responsibility.
...
Original readme.txt by Jacques Nomssi Nzali:
