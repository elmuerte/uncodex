...
procedure SIRegister_TUFunctionList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUFunctionList') do
...
procedure SIRegister_TUStateList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUStateList') do
...
procedure SIRegister_TUStructList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUStructList') do
...
procedure SIRegister_TUEnumList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUEnumList') do
...
procedure SIRegister_TUPropertyList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUPropertyList') do
...
procedure SIRegister_TUConstList(CL: TPSPascalCompiler);
begin
  //with RegClassS(CL,'TUObjectList', 'TUConstList') do
...
(*----------------------------------------------------------------------------*)
procedure TPSImport_unit_uclasses.CompOnUses(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
procedure TPSImport_unit_uclasses.ExecOnUses(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
...
(*----------------------------------------------------------------------------*)
procedure TPSImport_unit_uclasses.CompileImport2(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
